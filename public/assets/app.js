...
const STORAGE_KEY = "vunno-codelab-web";
...
function setDefaultContent() {
  ed_html.setValue(
    ...
    <section class="card" style="max-width:520px;margin:24px auto;padding:18px;text-align:center">
      <h1>This is Vunno editor</h1>
      <p>This example runs locally in the browser.</p>
      <button id="btn">Yo, watch this</button>
    </section>`,
    -1
  );
...
log("Vunno IDE is ready to go!");

function normalizeProject(raw) {
  if (!raw || typeof raw !== "object") throw new Error("Not an object");
  const html =
    typeof raw.html === "string" ? raw.html : (raw.web && raw.web.html) || "";
  const css =
    typeof raw.css === "string" ? raw.css : (raw.web && raw.web.css) || "";
  const js =
    typeof raw.js === "string" ? raw.js : (raw.web && raw.web.js) || "";

  return {
    version: 1,
    kind: "web-only",
    assignment:
      typeof raw.assignment === "string" ? raw.assignment : raw.task || "",
